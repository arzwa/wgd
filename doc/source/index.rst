...
1. ``codeml`` from the PAML package (http://abacus.gene.ucl.ac.uk/software/paml.html) (Yang 1997)
2. ``muscle`` for multiple sequence alignment (http://www.drive5.com/muscle/) (Edgar 2004)
3. ``mcl`` (https://micans.org/mcl/index.html) (Van Dongen 2000)
4. ``blastp`` and ``makeblastdb`` from the Blast+ suite (https://blast.ncbi.nlm.nih.gov/Blast.cgi?CMD=Web&PAGE_TYPE=BlastDocs&DOC_TYPE=Download) (Altschul `et al.` 2008)
5. ``i-adhore`` from the I-ADHoRe 3.0 suite (http://bioinformatics.psb.ugent.be/beg/tools/i-adhore30) (Proost `et al.` 2012)
